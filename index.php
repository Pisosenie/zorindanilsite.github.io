...
<main>
    <div class="container text-center">
        <h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-gamepad"></i> Games store</h1>
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                ...
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-book'></i>","Game Name", "book_name",""); ?>
                </div>
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class='fas fa-people-carry'></i>","
Developers", "book_publisher",""); ?>
                    </div>
                    <div class="col">
